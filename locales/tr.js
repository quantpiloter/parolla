export default {
  ...
  dialog: {
    ...
    menu: {
      ...
      reactionSoundFx: 'Tepki Sesleri',
      reactionSoundFxDesc: 'Tıklama, klavye, popup gibi tepki sesleri için',
      gameSceneSoundFx: 'Oyun Sahnesi Sesleri',
      gameSceneSoundFxDesc: 'Doğru, yanlış, pas ve süre gibi sahne sesleri için',
