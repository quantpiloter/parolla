export default {
  ...
  dialog: {
    ...
    menu: {
      ...
      reactionSoundFx: 'Reaction sounds',
      reactionSoundFxDesc: 'For reaction sounds like click, keyboard and popup',
      gameSceneSoundFx: 'Game scene sounds',
      gameSceneSoundFxDesc: 'For scene sounds like correct, wrong, pass and time',
    ...
    credits: {
      title: 'Credits',
      description:
        'parolla is an open source project. Check the <a href="https://github.com/quantpiloter/parolla" rel="nofollow,noopener" target="_blank">GitHub</a> link. Creators: <label><a href="https://twitter.com/selimdoyranli" target="_blank">@selimdoyranli</a></label> <label><a href="https://twitter.com/apo_bozdag" target="_blank">@apo_bozdag</a></label> <label><a href="https://twitter.com/muratozakcill" target="_blank">@muratozakcill</a></label>'
    },
    contact: {
      title: 'Contact',
      description:
